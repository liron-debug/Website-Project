...
namespace WonderLandServer
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<WonderLandServerContext>(options =>
                    options.UseSqlServer(Configuration.GetConnectionString("WonderLandServerContext")));
